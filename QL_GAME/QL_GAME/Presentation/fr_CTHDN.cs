    ...
    public partial class fr_CTHDN : Form
    {
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (cbhang.Text != "")
            {
                ...
                string uptt = "update tb_HDN set tongtien=(SELECT sum(thanhtien) FROM tb_CTHDN where sohdn='" + cbhd.Text + "') where sohdn='" + cbhd.Text + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:E2"].Font.Name = "Segoe UI bold";
            ...
            sql = @"SELECT     tb_CTHDN.sohdn, tb_NCC.tenncc, tb_NCC.diachi, tb_NCC.dienthoai, tb_Nhanvien.tennv,tb_HDN.ngaynhap,tb_HDN.tongtien
...
FROM         tb_CTHDN INNER JOIN
            ...
            for (hang = 0; hang <= tblThongtinHang.Rows.Count - 1; hang++)
            {
                ...
                for (cot = 0; cot <= tblThongtinHang.Columns.Count - 1; cot++)
                {
                    ...
                    if (cot == 2) exSheet.Cells[cot + 2][hang + 12] = tblThongtinHang.Rows[hang][cot].ToString() + " VND";
